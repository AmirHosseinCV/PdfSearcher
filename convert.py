...
parser.add_argument("--dpi", type=int, default=-1, help="manually set dpi, higher means better image quality, "
...
Image.open(io.BytesIO(doc[max(1, min(10, doc.page_count - 2))].get_pixmap(dpi=args.dpi).tobytes())).show()
df = None
...
if OCR:
    ...
    def run(i):
        ...
        img: fitz.fitz.Pixmap = page.get_pixmap(dpi=args.dpi)
